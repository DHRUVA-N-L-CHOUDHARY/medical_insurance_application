...
class MySharedPref {
  ...
  static const String _aadhaar = "aadhaar";
  ...
  //Phone getter setter
  static void setAadhar(String aadhaar) =>
      _sharedPreferences.setString(_aadhaar, aadhaar);

  static String? getAaadhar() => _sharedPreferences.getString(_aadhaar);
